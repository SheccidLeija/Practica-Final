...
// Crear cita (mascota_id opcional)
exports.crearCita = async (req, res) => {
  ...
  try {
    ...
    await pool.request()
      ...
      .input('mascota_id', sql.Int, mascota_id || null) // permite null si viene vacío
      .query(`
        INSERT INTO Citas (fecha, motivo, mascota_id, estado)
        VALUES (@fecha, @motivo, @mascota_id, 'programada')
      `);
